...
REVOKE ALL ON FUNCTION public.save_ai_plan(jsonb) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.save_ai_plan(jsonb) TO authenticated;
GRANT EXECUTE ON FUNCTION public.save_ai_plan(jsonb) TO service_role;