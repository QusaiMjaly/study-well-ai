...
REVOKE EXECUTE ON FUNCTION public.owns_ai_plan(uuid) FROM anon;
REVOKE EXECUTE ON FUNCTION public.owns_meal_day(uuid) FROM anon;
REVOKE EXECUTE ON FUNCTION public.owns_workout_day(uuid) FROM anon;
REVOKE EXECUTE ON FUNCTION public.save_ai_plan(jsonb) FROM anon;